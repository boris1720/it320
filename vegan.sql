...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2019 at 06:35 PM
...
(3, 13, 'vcvc', 'boris.dovecer@gmail.com', 'bcbvc', '2019-06-04', 'approve');
...
(18, 'Dimljeni tofu i šampinjoni', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\";color:windowtext;\'>Sastojci:</span></p><ul><li><span style=\"color:windowtext;\">Pakovanje dimljenog tofua</span></li><li><span style=\"color:windowtext;\">300g &scaron;ampinjona</span></li><li><span style=\"color:windowtext;\">2 mlada crna luka srednje veličine</span></li><li><span style=\"color:windowtext;\">1 mladi beli luk</span></li><li><span style=\"color:windowtext;\">so, biber, origano, kurkuma (možete dodati i druge začine po želji)</span></li><li><span style=\"color:windowtext;\">jedna ka&scaron;ika humusa</span></li><li><span style=\'font-size:16px;font-family:\"Calibri\",sans-serif;color:windowtext;\'>za salatu: paradajz, mix &scaron;argarepa i eisberg salata i sveži bosiljak i majčina du&scaron;ica</span></li></ul>', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Calibri\",sans-serif;color:windowtext;\'>Prvo iseckati sve sastojke. Luk na sitne deliće a tofu i &scaron;ampinjone na malo veće, kao &scaron;to je na slici. Potom sipati ulje po želji u dublji tiganj i kad se zagreje prvo sipati iseckan luk. Kada se to malo proprži, dodati iseckan tofu i pržiti dok ne porumeni sa obe strane. Potom sipati &scaron;ampinjone, sve to izme&scaron;ati i čekati da se i &scaron;ampinjoni isprže (odnosno izdinstaju jer će ispustiti dosta vode). Pred kraj sipati so, biber, začine, prome&scaron;ati, i držati na vatri jo&scaron; koji minut.</span></p><p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\";color:windowtext;\'>Napomena:&nbsp;</span><span style=\"color:windowtext;\">Servirati uz salatu po želji i malo humusa.</span></p>', 44, 'tofu', '2019-06-05', 1, 1, 2, 'dimljeni-tofu-i-sampinjoni', '30 minuta', 6),
(19, 'Dekonstruisana sarmica', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>Sastojci:</span></p><ul><li>400g spanaća (smrznut ili svež)</li><li>1 &scaron;olja pirinča</li><li>1 &scaron;olja sojinih ljuspica</li><li>soja sos</li></ul>', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>U tiganj sa malo vode sipajte sav spanać i ostavite da se krčka. Za to vreme u &scaron;erpu sipajte vodu + malo soli i kad to provri prvo odvadite jednom manjom džezvom malo te vrele vode, a onda u &scaron;erpu sipajte pirinač i ostavite da se kuva. U džezvu sa vrelom vodom sipajte 1 &scaron;olju sojinih ljuspica, prome&scaron;ajte i ostavite da odstoji par minuta. Kada ljuspice nabubre prespite ih u spanać, dodajte malo soja sosa (vremenom ćete steći osećaj koliko) i prome&scaron;ajte. Ostavite to na laganoj vatri minut, dva i onda isključite. Sačekajte da se skuva pirinač, procedite ga, pome&scaron;ajte sve i voila - dobili ste sarmicu bez forme!</span></p><p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>Napomena: Uz ovo jelo odlično ide Joya neutralna pavlaka. Naravno ako uspete da je nađete&hellip; Za sad izgleda da je ima samo u Tempu i to po nekad. Ali uskoro će se to stanje promeniti tako da imajte na umu da je odlična kombinacija. A ako ne nađete pavlaku, ekstra su i paradajz+krastavac kao salata. Prijatno!</span></p>', 48, 'sarme', '2019-06-05', 1, 1, 2, 'dekonstruisana-sarmica', '20 minuta', 3);
INSERT INTO `content` (`id`, `title`, `description`, `content_text`, `image`, `gallery`, `created_on`, `author_id`, `ct_id`, `category_id`, `slug`, `time`, `hits`) VALUES
(20, 'Mafini sa šargarepom', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>Sastojci:</span></p><ul><li>1 veća &scaron;argarepa</li><li>1 &scaron;to zrelija to bolje banana</li><li>laneno jaje (3 ka&scaron;ičice mlevenog lana + 1dl vode)</li><li>1 ka&scaron;ika maslinovog ulja</li><li>1 ka&scaron;ika meda (ili odgovarajuća količina drugog zaslađivača koji ide uz va&scaron;u filozofiju)</li><li>1 blendovana pomorandža</li><li>1 ka&scaron;ičica vanilinog ekstrakta ili vanilinog &scaron;ećera</li><li>ne skroz puna &scaron;olja ovsenih pahuljica</li><li>&frac34; &scaron;olje ovsenog bra&scaron;na (ili nekog drugog po želji)</li><li>ka&scaron;čica pra&scaron;ka za pecivo</li><li>ka&scaron;čica cimeta</li><li>ka&scaron;čica organskog kakao praha</li></ul><p><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>pola ka&scaron;čice sol</span></p>', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>U ča&scaron;i napraviti laneno jaje (pome&scaron;ati 1dl vode sa 3 ka&scaron;ike mlevenog lana) i ostaviti 10ak minuta da odstoji. Uključiti rernu da se zagreje na 200 stepeni, a za to vreme sitno izrendati &scaron;argarepu i pome&scaron;ati je sa izgnječenom bananom. U to dodati laneno jaje, ulje, med, blendovanu pomorandžu, vanilu i dobro izme&scaron;ati. Onda dodati i pahuljice, bra&scaron;no, pra&scaron;ak za pecivo, cimet i so i sve opet izme&scaron;ati. Po želji mogu se dodati i suncokretove semenke ili &nbsp;neko su&scaron;eno voće. Ako je previ&scaron;e tečno dodati jo&scaron; bra&scaron;na, ako je previ&scaron;e čvrsto dodati trunku biljnog mleka. <br>Ovu smesu možete sipati u modle za mafine ili oblikovati u oblutke na papiru za pečenje. Peče se oko 12 minuta i onda je gotovo.</span></p>', 57, 'mafini', '2019-06-09', 1, 1, 6, 'mafini-sa-sargarepom', '30 minuta', 7),
(21, 'Leblebije u kariju sa povrćem', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>Sastojci:</span></p><ul><li>2 paprike babure</li><li>2 paradajza</li><li>&scaron;olja sojinih ljuspica</li><li>tegla kuvanih leblebija</li><li>kari sos i začin</li><li>susam po želji</li><li>pola limuna</li><li>so, biber, aleva, kurkuma, korijander&hellip;</li></ul>', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Serif\",serif;\'>Iseckati babure na sitne delove i sa trunkom ulja ih ubaciti u tiganj da se prže, a za to vreme iseći i paradajz &ndash; isto na sitne komade i onda to dodati. Dodati i kuvane leblebije. U manju posudu sa ključalom vodom ubaciti sojine ljuspice i prome&scaron;ati. Kad nabubre, procediti ih i dodati u tiganj&nbsp;</span>(posle nekoliko poku&scaron;aja skontaćete dobar promer ljuspice:voda tako da nećete ni morati da ih cedite). Sipati karija, ne zna se koliko, ali otprilike&hellip; Ima i kari začin, a i sos &ndash; u ovom receptu su kori&scaron;ćena oba. Isprobajte pa vidite &scaron;ta vam godi. Prome&scaron;ati sve i krčkati dok paprike ne omek&scaron;aju. Sve to posuti sa malo susama, preliti sa sokom pola limuna i zavr&scaron;ili ste. Prijatno!</p>', 66, 'leb', '2019-06-09', 1, 1, 2, 'leblebije-u-kariju-sa-povrcem', '20 minuta', 3),
(22, 'Špageti bolonjeze', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>Sastojci:</span></p><ul><li><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>pola pakovanja &scaron;pageta</span></li><li><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>&scaron;olja sojinih ljuspica</span></li><li><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>paradajz sos</span></li><li><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>1 ljubičasti ili crni luk</span></li><li><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>1 &scaron;argarepa</span></li><li><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>so, biber, origano i ostali začini po ukusu</span></li></ul>', '<p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>Propržiti luk na trunki ulja (u tiganju) i dodati u to sitno rendanu &scaron;argarepu. U manjoj posudi zagrejati vodu do ključanja i onda dodati &scaron;olju sojinih ljuspica. Prome&scaron;ati i ostaviti da bleji. U tiganj sipati konzervu paradajz sosa, malo krčkati i dodati prethodno proceđene sojine ljuspice (posle nekoliko poku&scaron;aja skontaćete dobar promer ljuspice:voda tako da nećete ni morati da ih cedite). Smanjiti vatru na najmanje i ostaviti da se krčka, a za to vreme skuvati &scaron;pagete tako &scaron;to u proključalu vodu sa malo soli dodate &scaron;pagete i uz povremeno me&scaron;anje pričekate 10ak minuta. Sipajte &scaron;pagete u tanjir i prelijte sosom, pome&scaron;ajte i to je to!</span></p><p class=\"Standard\"><span style=\'font-size:16px;font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>Napomena:&nbsp;</span><span style=\'font-family:\"Liberation Sans\",sans-serif;color:windowtext;\'>Nakon &scaron;to servirate možete dodati svež bosiljak, masline ili nutritivni kvasac na vrh.</span></p>', 75, 'spagete', '2019-06-09', 1, 1, 2, 'spageti-bolonjeze', '30 minuta', 3);
...
(34, 'tofu', 'tofu i pecurke sa lukom.jpg'),
(35, 'tofu', 'priprema tofua i sampinjona.jpg'),
(36, 'sarme', 'spanac i soja u tiganju.jpg'),
(37, 'sarme', 'spanac soja i pirinac u tiganju.jpg'),
(38, 'sarme', 'dekonstruisana sarma.jpg'),
(39, 'mafini', '2-izgnjecena-banana.jpg'),
(40, 'mafini', '3-laneno-jaje.jpg'),
(41, 'mafini', '4-blendana-pomorandza.jpg'),
(42, 'mafini', '1-izrendana-samgarepa.jpg'),
(43, 'mafini', '5-miks-svegatoga.jpg'),
(44, 'mafini', '6-ovsene-pahuljice.jpg'),
(45, 'mafini', '7-ovseno-brasno.jpg'),
(46, 'mafini', '9-u-rerni.jpg'),
(47, 'mafini', '11-reprezent.jpg'),
(48, 'mafini', '8-opet-miks.jpg'),
(49, 'mafini', '12-njaam.jpg'),
(50, 'mafini', '10-iz-rerne.jpg'),
(51, 'leb', '1-dinstanje-paprike.jpg'),
(52, 'leb', '4-plus-leblebije.jpg'),
(53, 'leb', '3-ljuspice-u-solji.jpg'),
(54, 'leb', '2-dodavanje-paradajza.jpg'),
(55, 'leb', '6-susam-i-kari.jpg'),
(56, 'leb', '7-serviran-specijalitet.jpg'),
(57, 'leb', '8-specijalitet-izbliza.jpg'),
(58, 'spagete', '5-ljuspice-nabubrile.jpg'),
(59, 'spagete', '1-proprziti-luk.jpg'),
(60, 'spagete', '2-soljica-sojinih-ljuspica.jpg'),
(61, 'spagete', '3-dodati-sargarepu.jpg'),
(62, 'spagete', '6-sve-pomesati.jpg'),
(63, 'spagete', '8-spageti-bolonjeze.jpg'),
(64, 'spagete', '4-dodati-paradajz.jpg'),
(65, 'spagete', '9-spageti-bolonjeze-vege.jpg'),
(66, 'spagete', '7-skuvati-spagete.jpg');
...
(44, 'tofu i pecurke sa lukom.jpg', '2019-06-05'),
(45, 'priprema tofua i sampinjona.jpg', '2019-06-05'),
(46, 'spanac i soja u tiganju.jpg', '2019-06-05'),
(47, 'spanac soja i pirinac u tiganju.jpg', '2019-06-05'),
(48, 'dekonstruisana sarma.jpg', '2019-06-05'),
(49, '2-izgnjecena-banana.jpg', '2019-06-09'),
(50, '3-laneno-jaje.jpg', '2019-06-09'),
(51, '4-blendana-pomorandza.jpg', '2019-06-09'),
(52, '1-izrendana-samgarepa.jpg', '2019-06-09'),
(53, '5-miks-svegatoga.jpg', '2019-06-09'),
(54, '6-ovsene-pahuljice.jpg', '2019-06-09'),
(55, '7-ovseno-brasno.jpg', '2019-06-09'),
(56, '9-u-rerni.jpg', '2019-06-09'),
(57, '11-reprezent.jpg', '2019-06-09'),
(58, '8-opet-miks.jpg', '2019-06-09'),
(59, '12-njaam.jpg', '2019-06-09'),
(60, '10-iz-rerne.jpg', '2019-06-09'),
(61, '1-dinstanje-paprike.jpg', '2019-06-09'),
(62, '4-plus-leblebije.jpg', '2019-06-09'),
(63, '3-ljuspice-u-solji.jpg', '2019-06-09'),
(64, '2-dodavanje-paradajza.jpg', '2019-06-09'),
(65, '6-susam-i-kari.jpg', '2019-06-09'),
(66, '7-serviran-specijalitet.jpg', '2019-06-09'),
(67, '8-specijalitet-izbliza.jpg', '2019-06-09'),
(68, '5-ljuspice-nabubrile.jpg', '2019-06-09'),
(69, '1-proprziti-luk.jpg', '2019-06-09'),
(70, '2-soljica-sojinih-ljuspica.jpg', '2019-06-09'),
(71, '3-dodati-sargarepu.jpg', '2019-06-09'),
(72, '6-sve-pomesati.jpg', '2019-06-09'),
(73, '8-spageti-bolonjeze.jpg', '2019-06-09'),
(74, '4-dodati-paradajz.jpg', '2019-06-09'),
(75, '9-spageti-bolonjeze-vege.jpg', '2019-06-09'),
(76, '7-skuvati-spagete.jpg', '2019-06-09');
...
ALTER TABLE `tag_content`
  ...
  ADD CONSTRAINT `tag_content_ibfk_3` FOREIGN KEY (`content_id`) REFERENCES `content` (`id`);
COMMIT;
